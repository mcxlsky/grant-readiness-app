                ...
                <div className="border-b border-gray-200 p-5 dark:border-neutral-800">
                  <form onSubmit={handleSearch} className="space-y-2.5">
                    ...
                    <button
                      type="submit"
                      disabled={loading}
                      className="w-full rounded-lg bg-indigo-600 py-2.5 text-base md:text-sm font-medium text-white transition-colors hover:bg-indigo-500 disabled:opacity-50"
                    >
                      {loading ? <span className="spinner" /> : "Search"}
                    </button>
                  </form>
                  <p className="mt-3 text-[11px] text-gray-400 dark:text-neutral-500">
                    Searches live IRS/ProPublica records.
                  </p>
                </div>
